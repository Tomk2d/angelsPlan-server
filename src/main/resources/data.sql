...
('프로젝트 기획서 작성', '2024년 1분기 프로젝트 기획서 초안 작성', false, NOW(), NOW()),
('디자인 시안 검토', '메인 페이지 디자인 시안 3개 검토 및 피드백', true, NOW(), NOW()),
('API 문서 작성', 'REST API 엔드포인트 문서화 작업', false, NOW(), NOW()),
('테스트 코드 작성', '사용자 인증 모듈 단위 테스트 작성', false, NOW(), NOW()),
('데이터베이스 스키마 설계', '회원 관리 시스템 DB 스키마 설계 및 검토', true, NOW(), NOW()),
('버그 수정', '로그인 페이지 무한 로딩 이슈 해결', false, NOW(), NOW()),
('성능 최적화', '이미지 로딩 속도 개선 작업', false, NOW(), NOW()),
('코드 리뷰', '팀원들의 PR 검토 및 피드백 작성', true, NOW(), NOW()),
('보안 점검', '취약점 분석 및 보안 이슈 점검', false, NOW(), NOW()),
('배포 자동화', 'CI/CD 파이프라인 구축 작업', false, NOW(), NOW());
